...
export default function AuthTemplate({
  ...
  return (
    <div className="fade-in container pl-0 flex max-w-6xl dark:bg-base-50 mt-16 rounded-lg border dark:border-base-content dark:border-black/10 shadow-md dark:bg-black/20">
